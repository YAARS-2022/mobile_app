...
class DistanceMeasurement {
  ...
  static measureDistance() async {
    double parentLat, parentLon, childLat, childLon;

    print('Getting the position of parent');

    Position currentPosition = await determinePosition();
    parentLat = currentPosition.latitude;
    parentLon = currentPosition.longitude;

    print('Got position : $currentPosition');
